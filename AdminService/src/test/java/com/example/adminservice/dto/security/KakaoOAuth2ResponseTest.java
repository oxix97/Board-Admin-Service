package com.example.adminservice.dto.security;
...
@DisplayName("[DTO 테스트] Kakao OAuth 2.0 인증 응답 데이터")
class KakaoOAuth2ResponseTest {

    private final ObjectMapper mapper = new ObjectMapper();

    @DisplayName("인증 결과를 JSON(Map)으로 받으면, 카카오 인증 응답 데이터와 비교한다.")
    @Test
    void test1() throws Exception {
        String responseData = """
                ...
                """;
        Map<String, Object> attributes = mapper.readValue(responseData, new TypeReference<>() {});
