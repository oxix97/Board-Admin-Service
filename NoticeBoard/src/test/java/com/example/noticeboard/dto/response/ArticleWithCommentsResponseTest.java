...
class ArticleWithCommentsResponseTest {
    ...
    @Test
    void givenArticleWithCommentDtoWithoutChildComments_whenMapping_thenOrganizesCommentsWithCertainOrder() {
        // Given
        ...
        ArticleWithCommentDto input = createArticleWithCommentDto(articleCommentDtos);
    ...
    @Test
    void givenArticleWithCommentDto_whenMapping_thenOrganizesParentAndChildCommentsWithCertainOrders() {
        // Given
        LocalDateTime now = LocalDateTime.now();
        Set<ArticleCommentDto> articleCommentDtos = Set.of(
                createArticleCommentDto(1L, null, now),
    ...
    @Test
    void givenArticleWithCommentDto_whenMapping_thenOrganizesParentAndChildCommentsWithoutDepthLimit() {
        // Given
        LocalDateTime now = LocalDateTime.now();
        Set<ArticleCommentDto> articleCommentDtos = Set.of(
                createArticleCommentDto(1L, null, now),
    ...
    private ArticleWithCommentDto createArticleWithCommentDto(Set<ArticleCommentDto> articleCommentDtos) {
