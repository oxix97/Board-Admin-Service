...
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at, modified_by) values
    ('chan', '{noop}123', 'chan', 'chan@mail.com', 'I am chan.', now(), 'chan', now(), 'chan');
...
-- 300 댓글
insert into comment (article_id, user_id, parent_comment_id, content, created_at, modified_at, created_by, modified_by) values
